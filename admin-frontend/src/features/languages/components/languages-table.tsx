...
import { useLanguagesColumns } from './languages-columns'
...
export function LanguagesTable({ search, navigate }: DataTableProps) {
  const {
    languages,
    isLoading,
    total,
  ...
  const columns = useLanguagesColumns({ onEdit: handleEdit, onDelete: handleDelete })
