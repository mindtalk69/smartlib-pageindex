...
import { useCatalogsColumns } from './catalogs-columns'
import { useCatalogs } from './catalogs-provider'
import { CatalogsDialogs } from './catalogs-dialogs'
...
export function CatalogsTable({ search, navigate }: DataTableProps) {
  const {
    open,
    setOpen,
    currentRow,
  ...
  const columns = useCatalogsColumns({ navigate })
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter catalogs...'
      />
