...
import { useKnowledgesColumns } from './knowledges-columns'
import { useKnowledges } from './knowledges-provider'
import { KnowledgesDialogs } from './knowledges-dialogs'
...
export function KnowledgesTable({ search, navigate }: DataTableProps) {
  const {
    open,
    setOpen,
    currentRow,
  ...
  const columns = useKnowledgesColumns({ navigate })
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter knowledges...'
      />
