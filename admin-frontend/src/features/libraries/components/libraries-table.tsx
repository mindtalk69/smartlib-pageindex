...
import { useLibrariesColumns } from './libraries-columns'
import { useLibraries } from './libraries-provider'
import { LibrariesDialogs } from './libraries-dialogs'
...
export function LibrariesTable({ search, navigate }: DataTableProps) {
  const {
    open,
    setOpen,
    currentRow,
  ...
  const columns = useLibrariesColumns({ navigate })
