...
class Config:
    ...
    # --- Docling Config ---
    # Default export type (actual behavior is determined by OCR mode in upload_processing.py)
    # Azure DocInt → MARKDOWN, Local OCR → DOC_CHUNKS
    DOCLING_EXPORT_TYPE = os.environ.get('DOCLING_EXPORT_TYPE', 'DOC_CHUNKS')
