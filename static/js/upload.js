(function () { // Using an IIFE to keep scope clean
    ...
    // Initialize visual grounding OCR mode warning
    if (visualGroundingCheckbox && visualGroundingOcrWarning) {
        ...
        // Check initial state
        updateVisualGroundingWarning();

        console.log('[Upload] Visual Grounding OCR check initialized. OCR mode:', ocrMode, 'isLocal:', isOcrLocal);
    }
